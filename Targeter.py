...
class Targeter:
    ...
    def target_enemy(self):
        # returns a clicked enemy inside FOV up to a range
        ...
        while True:
            ...
            for obj in g.actors:
                if obj.x == x and obj.y == y and obj.combatant \
                        and obj != self.owner:
                    return obj
    ...
    def target_closest(self):
        ...
        for obj in g.actors:
            if obj.combatant and not obj == self.owner \
                    and libtcod.map_is_in_fov(display.fov_map, obj.x, obj.y):
